...
class Visualizer3d:
    ...
    def _init_options(self):
        ...
        self.vis.register_key_action_callback(ord('P'), lambda a, b, c: b == 1 or setattr(self.paused, "value",
    ...
    def transform_geometry_relative(self, transform_prev_list, transform_curr_list, geom_list):
        for idx, geom in enumerate(geom_list):
            ...
            geom.rotate(torch.matmul(torch.inverse(T_prev[0:3, 0:3]), T_curr[0:3, 0:3]),
                        center=(T_prev[0, -1], T_prev[1, -1], T_prev[2, -1]))

            # b. translate by t2 - t1
            geom.translate(
                (T_curr[0, -1] - T_prev[0, -1], T_curr[1, -1] - T_prev[1, -1], T_curr[2, -1] - T_prev[2, -1]))
