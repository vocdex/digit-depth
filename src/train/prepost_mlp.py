...
def preproc_mlp(filename:str) -> torch.Tensor:
    """
        Args: filename: path to the image file
...
def post_proc_mlp(model_output: torch.Tensor):
    """
    :param model_output: torch.Tensor of shape (1,3)
    ...
    test_np = test_np*255  # convert to uint8 for visualization
